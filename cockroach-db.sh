...
sudo cp -i cockroach-v21.3.7.linux-amd64/lib/libgeos.so /usr/local/lib/cockroach/
sudo rm -f /usr/local/lib/cockroach/libgeos_c.so
sudo cp -i cockroach-v21.3.7.linux-amd64/lib/libgeos_c.so /usr/local/lib/cockroach/
